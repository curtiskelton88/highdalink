...
function Pricing() {
  ...
  return (
    <>
      <SEOHead 
        title="Elite Link Building Pricing - DR90+ Editorial Backlinks"
        description="Transparent pricing for elite DR90+ DA90+ editorial backlinks. Elite One ($600), Authority Pro ($1,100), Agency Monthly ($2,000). 30-day money-back guarantee."

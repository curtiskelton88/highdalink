      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Real results from businesses that trust our DR90+ editorial backlinks</p>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 text-white">
              ...
              <p className="text-xl text-blue-100 mb-6">
                Get the same DR90+ editorial backlinks that helped these brands dominate their markets
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  to="/get-started"
                  className="bg-white text-blue-600 px-8 py-4 rounded-xl hover:bg-gray-100 transition-all transform hover:scale-105 font-semibold inline-flex items-center justify-center text-lg shadow-lg"
                >
                ...
                <Link 
                  to="/roi-calculator"
                  className="border-2 border-white text-white px-8 py-4 rounded-xl hover:bg-white hover:text-blue-600 transition-all font-semibold inline-flex items-center justify-center text-lg"
                >
                  <Calculator className="h-5 w-5 mr-2" />
                  Calculate Your ROI
                </Link>
